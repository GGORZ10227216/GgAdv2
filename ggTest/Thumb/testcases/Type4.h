    ...
    void CalleeCheek(CPU& local_cpu, const unsigned Op) {
        switch (Op) {
            case 0:
                ...
                break ;
            case 1:
                ASSERT_TRUE(local_cpu.lastCallee == ALU_Operations<EOR>) ;
                break ;
            case 2:
                ASSERT_TRUE(local_cpu.lastCallee == ALU_Operations<LSL>) ;
                break ;
            case 3:
                ASSERT_TRUE(local_cpu.lastCallee == ALU_Operations<LSR>) ;
                break ;
            case 4:
                ASSERT_TRUE(local_cpu.lastCallee == ALU_Operations<ASR>) ;
                break ;
            case 5:
                ASSERT_TRUE(local_cpu.lastCallee == ALU_Operations<ADC>) ;
                break ;
            case 6:
                ASSERT_TRUE(local_cpu.lastCallee == ALU_Operations<SBC>) ;
                break ;
            case 7:
                ASSERT_TRUE(local_cpu.lastCallee == ALU_Operations<ROR>) ;
                break ;
            case 8:
                ASSERT_TRUE(local_cpu.lastCallee == ALU_Operations<TST>) ;
                break ;
            case 9:
                ASSERT_TRUE(local_cpu.lastCallee == ALU_Operations<RSB>) ;
                break ;
            case 10:
                ASSERT_TRUE(local_cpu.lastCallee == ALU_Operations<CMP>) ;
                break ;
            case 11:
                ASSERT_TRUE(local_cpu.lastCallee == ALU_Operations<CMN>) ;
                break ;
            case 12:
                ASSERT_TRUE(local_cpu.lastCallee == ALU_Operations<ORR>) ;
                break ;
            case 13:
                ASSERT_TRUE(local_cpu.lastCallee == ALU_Operations<0>) ; // MUL
                break ;
            case 14:
                ASSERT_TRUE(local_cpu.lastCallee == ALU_Operations<BIC>) ;
                break ;
            case 15:
                ASSERT_TRUE(local_cpu.lastCallee == ALU_Operations<MVN>) ;
                break ;
            default:
