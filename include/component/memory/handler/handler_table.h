...
namespace gg_core::gg_mem {
    ...
    constexpr std::array<AccessHandler, 16> ReadHandlers {
        ...
        /*0x8 GAMEPAK_0*/std::make_tuple(ROM_Read<uint8_t, E_WS0>, ROM_Read<uint16_t, E_WS0>,
                                         ROM_Read<uint32_t, E_WS0>),
        /*0x9 GAMEPAK_0*/std::make_tuple(ROM_Read<uint8_t, E_WS0>, ROM_Read<uint16_t, E_WS0>,
                                         ROM_Read<uint32_t, E_WS0>),
        /*0xA GAMEPAK_1*/std::make_tuple(ROM_Read<uint8_t, E_WS1>, ROM_Read<uint16_t, E_WS1>,
                                         ROM_Read<uint32_t, E_WS1>),
        /*0xB GAMEPAK_1*/std::make_tuple(ROM_Read<uint8_t, E_WS1>, ROM_Read<uint16_t, E_WS1>,
                                         ROM_Read<uint32_t, E_WS1>),
        /*0xC GAMEPAK_2*/std::make_tuple(ROM_Read<uint8_t, E_WS2>, ROM_Read<uint16_t, E_WS2>,
                                         ROM_Read<uint32_t, E_WS2>),
        /*0xD GAMEPAK_2*/std::make_tuple(ROM_Read<uint8_t, E_WS2>, ROM_Read<uint16_t, E_WS2>,
                                         ROM_Read<uint32_t, E_WS2>),
